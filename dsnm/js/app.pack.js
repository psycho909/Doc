...
.service('My', function($rootScope, $location, $interval, $log, $filter, $cookies, Tools, PATH, $window) {
	var self = this;
	...
	this.toBOING=function(gType,vName){
		$window.open(domainConfig.webUrl+'/index1?act=toBOING&gp=' + gType + '&user=' + self.info.username,vName);
	};
